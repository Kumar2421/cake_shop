...
# they must be present here — supplying them only at runtime ships an image
# that cannot reach Supabase. generateStaticParams also queries the database
# during this build, which needs the same two values.
